...
type InvitationRow = { id: string; space_id: string; email: string; role: string; invited_by: string; token_hash: string; expires_at: string; accepted_at: string | null; created_at: string };
