    ...
    <View style={{ flex: 1, backgroundColor: COLORS.canvas }}>
      <ScrollView contentInsetAdjustmentBehavior="automatic" contentContainerStyle={{ padding: GUTTER, paddingBottom: 110, gap: 24 }}>
        <View style={{ backgroundColor: space.color, borderRadius: RADIUS.large, padding: 20, gap: 16 }}>
          <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}><View style={{ width: 46, height: 46, borderRadius: 16, backgroundColor: '#FFFFFF22', alignItems: 'center', justifyContent: 'center' }}><Glyph name="people" size={22} color="#FFFFFF" /></View><Pressable accessibilityRole="button" accessibilityLabel="Manage space members" onPress={() => router.push({ pathname: '/space-members', params: { spaceId: space.id } })} style={{ width: 46, height: 46, borderRadius: 16, backgroundColor: '#FFFFFF22', alignItems: 'center', justifyContent: 'center' }}><Glyph name="people" size={20} color="#FFFFFF" /></Pressable></View>
