...
export default function SettingsScreen() {
  ...
  async function connectCalendar() {
    ...
    setBusy(false);
    Alert.alert(granted ? 'Calendar connected' : 'Calendar not connected', granted ? 'Do It Right will only read today’s commitments to give your plan useful context.' : 'Calendar access is unavailable or was declined. Your planning still works without it.');
  }
  ...
  return (
    <>
      ...
      <View style={{ flex: 1, backgroundColor: COLORS.canvas }}><ScrollView contentInsetAdjustmentBehavior="automatic" contentContainerStyle={{ paddingHorizontal: GUTTER, paddingTop: 20, paddingBottom: 42, gap: 25 }}>
        <View style={{ gap: 6 }}><Text selectable style={{ color: COLORS.ink, fontSize: 30, lineHeight: 35, fontWeight: '900', letterSpacing: -0.8 }}>Make it yours.</Text><Text style={{ color: COLORS.muted, fontSize: 14, lineHeight: 20, fontWeight: '600' }}>A few quiet choices shape how Do It Right meets you.</Text></View>
