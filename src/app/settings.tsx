...
const PALETTES = [
  { id: 'warm', label: 'Terracotta', color: '#E06A3D' },
  { id: 'forest', label: 'Sage', color: '#2E7D5B' },
  { id: 'ocean', label: 'Sky', color: '#3F82F6' },
  { id: 'berry', label: 'Berry', color: '#9C3F67' },
  { id: 'gold', label: 'Clay', color: '#D8B98C' },
] as const;
...
export default function SettingsScreen() {
  ...
  const [customAccent, setCustomAccent] = React.useState(profile.appearance.customAccent ?? '#E06A3D');
